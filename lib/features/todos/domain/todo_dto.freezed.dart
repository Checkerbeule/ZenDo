...
as Set<String>,willBeTransferred: null == willBeTransferred ? _self.willBeTransferred : willBeTransferred // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@override@JsonKey() final  bool willBeTransferred;
